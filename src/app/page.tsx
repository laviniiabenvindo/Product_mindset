...
const menuItem = [
  { url: '#/books', title: 'Livros' },
  { url: '#/about', title: 'Sobre' },
  { url: '#/contact', title: 'Contatos' },
];
    ...
    <div>
      <Box>
        {isLargeScreen && (
          <nav className="flex bg-blue-900 fixed scroll-mt-0 w-full z-50 items-center justify-evenly">
            ...
            <div className="flex justify-center w-full items-center gap-2">
              <span className="flex gap-10 text-white">
        ...
        {(isMediumScreen || isSmallScreen) && (
          <nav className="flex bg-blue-900 fixed w-screen z-50 items-center justify-evenly">
            <Link className="cursor-pointer flex w-full" href={'/'}>
              <Image
                src="/product_mindset_logo.png"
                alt="product mindset logo"
                className="pt-2"
        ...
        {isLargeScreen && (
          <main className="flex flex-col items-center gap-8 justify-between pb-5">
            <div className="flex items-center p-10 w-full flex-col justify-center gap-5 h-full">
              ...
              <p
                id="/books"
                className="text-xl border-l-8 border-l-sky-800 pl-5"
              >
              ...
              <div className="flex items-center">
                ...
                <Box className="flex flex-col items-center  gap-5 justify-between h-full w-1/2">
                  ...
                  <p className="text-justify w-2/5 text-sm">
                    ...
                    eficiência e inovação. Explore modelos tradicionais e
                    práticas ágeis modernas do setor. Ideal para quem quer criar
                    produtos de qualidade e se destacar na tecnologia.
                  </p>
        ...
        {(isSmallScreen || isMediumScreen) && (
          <main className="flex flex-col items-center gap-20">
            <div className="flex items-center p-10 w-full flex-col justify-center gap-5 h-full">
              ...
              <p
                id="/books"
                className="text-sm border-l-8 border-l-sky-800 pl-5"
              >
                Abra sua mente para o mundo da tecnologia! <br /> Nova forma de
                enxergar o desenvolvimento de produtos.
              </p>
            ...
            <Box className="flex flex-col items-center gap-5 justify-center">
              <p className="text-xl">Exemplares Publicados</p>
              <div className="flex flex-col items-center gap-5 ">
                <Box className="flex flex-col h-full w-4/5 items-center gap-4">
                  <div className="flex items-center gap-4">
                    <Button onClick={handlePrev}>
                      <ArrowBack />
                    </Button>
                  ...
                  <p className="w-4/5 text-justify text-xs">
                    Este eBook apresenta uma abordagem prática e direta sobre
                    requisitos de software. Um guia essencial para quem deseja
                    desenvolver software realmente alinhado às
                    necessidades do cliente.
                ...
                <Box className="flex flex-col items-center gap-5 h-full w-4/5">
                  <div className="flex items-center gap-4">
                    <Button onClick={handlePrevL}>
                      <ArrowBack />
                    </Button>
      ...
      <Box>
              ...
              <Box className="flex flex-col items-center gap-10 justify-center">
                <Box className="flex flex-col items-center justify-center">
                  <p className="text-justify w-1/2">
                    O <strong>Product Mindset Instituto</strong> nasce com a
                    missão de transformar a forma como empresas e profissionais
                    enxergam o desenvolvimento de produtos, promovendo uma
                    mentalidade voltada para inovação, eficiência e impacto real
                    no mercado. Com uma abordagem fundamentada em metodologias
                    ágeis, design thinking e estratégias de gestão de produtos,
                    o instituto capacita líderes, times e organizações para
                    alcançar excelência na entrega de valor.
                  </p>
                </Box>
        ...
        {(isMediumScreen || isSmallScreen) && (
          <section className="flex p-10">
            <section className="flex flex-col items-center gap-10 justify-between h-full w-full">
              <p className="text-xl">Sobre o instituto</p>
              <Box className="flex flex-col items-center gap-10 justify-center">
                <Box className="flex flex-col items-center justify-center">
                ...
                <Button id="/contact" variant="contained" color="secondary">
                  <Link href={'/About'}>Conhecer o instituto</Link>
                </Button>
              </Box>
            </section>
      ...
      <Box>
        ...
        {(isMediumScreen || isSmallScreen) && (
          <article>
            <Box className="flex flex-col items-center gap-5 justify-center h-screen px-10 w-full">
              <p className="text-4xl">Fale conosco</p>
              <FormControl
                onSubmit={enviarEmail}
      ...
      <Box>
        ...
        {(isMediumScreen || isSmallScreen) && (
          <footer className="flex flex-col bg-blue-900 w-full items-center pb-5 justify-evenly h-full">
            <Box className="flex items-center justify-evenly w-full">
              <Image
                ...
                height={100}
              />
              <span className="flex flex-col text-white gap-2 items-center">
